...
# def del_all(pas):
#     conn = psycopg2.connect(database="netology_db",user="postgres",password="erohin1987")
...
def add_phone(pas):
    ...
    conn = psycopg2.connect(ddatabase="netology_db",user="postgres",password=erohin1987)
    with conn.cursor() as cur:
